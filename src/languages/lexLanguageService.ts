...
export function getLanguageService(): LanguageService {
	return {
		...
		doValidation: (document, lexDocument) =>
			doLEXValidation(document, lexDocument),
		doComplete: (document, position, lexDocument) =>
		...
		findReferences: (document, position, lexDocument) =>
			doLEXFindReferences(document, position, lexDocument),
		doRename: (document, position, newName, lexDocument) =>
			doLEXRename(document, position, newName, lexDocument),
	};
}
